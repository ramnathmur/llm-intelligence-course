/**
 * AI Engineering Learning Package — Navigation & Progress
 *
 ...
 *
 * No dependencies. Works offline. All paths relative to ai-engineering/.
 */
...
const MODULES = [
  {
    ...
    color: 'var(--cyan)',
    gaps: [
      { id: 'E01', slug: 'e01-prompt-engineering', title: 'Prompt Engineering as a System' },
      { id: 'E02', slug: 'e02-context-engineering', title: 'Context Engineering' },
      { id: 'E03', slug: 'e03-structured-outputs', title: 'Structured Outputs' },
    ]
  },
  {
    id: 2,
    ...
    color: 'var(--green)',
    gaps: [
      { id: 'E04', slug: 'e04-rag-architecture', title: 'RAG Architecture' },
      { id: 'E05', slug: 'e05-vector-databases', title: 'Vector Databases' },
      { id: 'E06', slug: 'e06-retrieval-failure-modes', title: 'Retrieval Failure Modes' },
    ]
  },
  {
    id: 3,
    ...
    color: 'var(--purple)',
    gaps: [
      { id: 'E07', slug: 'e07-agent-orchestration', title: 'Agent Orchestration Patterns' },
      { id: 'E08', slug: 'e08-evaluation-pipelines', title: 'Evaluation Pipelines' },
      { id: 'E09', slug: 'e09-fine-tuning-practice', title: 'Fine-Tuning in Practice' },
    ]
  },
  {
    id: 4,
    ...
    color: 'var(--amber)',
    gaps: [
      { id: 'E10', slug: 'e10-llmops', title: 'LLMOps — Running LLM Systems in Production' },
      { id: 'E11', slug: 'e11-red-teaming', title: 'Red-Teaming and Adversarial Testing' },
    ]
  }
];

const LEARNING_PATH = [
  'e01-prompt-engineering','e02-context-engineering','e03-structured-outputs',
  'e04-rag-architecture','e05-vector-databases','e06-retrieval-failure-modes',
  'e07-agent-orchestration','e08-evaluation-pipelines','e09-fine-tuning-practice',
  'e10-llmops','e11-red-teaming'
];

const STORAGE_KEY = 'ai-engineering-progress';
  ...
  let html = `
    <div class="sidebar-header">
      <div style="display:flex;align-items:center;justify-content:space-between;">
        <h1><a href="${indexHref}">AI Engineering</a></h1>
        <button class="theme-toggle" aria-label="Toggle theme">${themeIcon}</button>
      </div>
      <p>Build Reliable LLM Systems</p>
